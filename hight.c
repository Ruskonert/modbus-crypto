...
BYTE* decrypt(BYTE* data, int dataPen, BYTE* key) {
...
int main(int argc, char* argv[])
{
	...
	BYTE plainText[] = {0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};
	...
	for (i=0;i<nPlainTextLen;i++)	{printf("%c",plainText[i]);}
